...
const i18n = {
    ko: {
        ...
        'hero-subtitle': '그럴듯한 문장에 현혹되지 마세요.<br/><span class="pretendard">올라</span><span class="ollarai-brand">AI</span>는 환각(Hallucination) 없이 공시 데이터 그대로의<br/><span class="text-primary font-semibold">진실된 숫자</span>를 인출합니다.',
        ...
        'features-title': '왜 <span class="pretendard">올라</span><span class="ollarai-brand">AI</span>여야만 하는가',
        ...
        'feat1-tooltip': '블룸버그에 비하면 아직은 버그에 불과하지만 <span class="pretendard">올라</span><span class="ollarai-brand">ai</span>의 데이터 커버리지는 매일 조금씩 넓어지고 있습니다.',
        'feat2-title': '질문 그 이상의 통찰,<br/>프로의 데이터를 연결합니다.',
        'feat2-desc': '"이 종목 왜 올라?"라는 단순한 질문에도 <span class="pretendard">올라</span><span class="ollarai-brand">AI</span>는 전문 투자자의 시나리오로 응답합니다. 뉴스 제목 요약이 아니라, 해당 종목의 <span class="text-primary font-bold">선행 지표와 원가 구조</span>까지 파고들어 입체적인 보고서를 즉시 구성합니다.',
        ...
        'feat3-desc': '우리는 단순한 가이드를 주지 않습니다. <span class="pretendard">올라</span><span class="ollarai-brand">AI</span>는 압도적인 데이터를 무기로 스스로 가설을 세우고 <b>목표가(Target Price)</b>를 산출하는 지능형 에이전트입니다. 실제 시장에서 인간 애널리스트와 수익률로 경쟁하며, 더 높은 정확도로 당신의 곁에서 성과를 증명할 것입니다.',
        ...
        'dialog-default': '<span class="pretendard">올라</span><span class="ollarai-brand">ai</span>는 현재 열심히 준비중입니다.<br/>조금만 기다려주세요!',
        'dialog-close': '확인',

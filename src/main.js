...
const i18n = {
    ko: {
        ...
        'screening-title': '어디에도 없는 AI주식 스크리닝',
        'screening-desc': '검증된 숫자와 웹상에 떠도는 모든 정보를 기반으로 좋은 주식을 찾으세요. 공시 원문과 직접 인출한 재무 데이터와 실적 지표 그리고 기업별 미래 이벤트 캘린더로, 저평가 성장 기업을 정밀하게 걸러내는 스크리닝을 <span class="ollarai-brand">Ollarai</span>에서 만나보세요.',
        'screening-point1': 'PER, ROE, 영업이익률 등 검증된 재무 지표 기반 필터링',
        'screening-point2': '공시 원본 데이터와 이벤트 캘린더로 산출한 스코어링',
        'screening-point3': '한·미·일 시장을 아우르는 크로스보더 스크리닝',
        ...
        'features-title': '왜 <span class="ollarai-brand">Ollarai</span>여야만 하는가',
        ...
        'feat1-tooltip': '블룸버그에 비하면 아직은 버그에 불과하지만 <span class="ollarai-brand">Ollarai</span>의 데이터 커버리지는 매일 조금씩 넓어지고 있습니다.',
        'feat2-title': '질문 그 이상의 통찰,<br/>프로의 데이터를 연결합니다.',
        'feat2-desc': '"이 종목 왜 올라?"라는 단순한 질문에도 <span class="ollarai-brand">Ollarai</span>는 전문 투자자의 시나리오로 응답합니다. 뉴스 제목 요약이 아니라, 해당 종목의 <span class="text-primary font-bold">선행 지표와 원가 구조</span>까지 파고들어 입체적인 보고서를 즉시 구성합니다.',
        ...
        'feat3-desc': '우리는 단순한 가이드를 주지 않습니다. <span class="ollarai-brand">Ollarai</span>는 압도적인 데이터를 무기로 스스로 가설을 세우고 <b>목표가(Target Price)</b>를 산출하는 지능형 에이전트입니다. 실제 시장에서 인간 애널리스트와 수익률로 경쟁하며, 더 높은 정확도로 당신의 곁에서 성과를 증명할 것입니다.',
        ...
        'footer-copyright': `&copy; ${new Date().getFullYear()} Ollarai (올라라이). All rights reserved.`,
    ...
    en: {
        ...
        'screening-title': 'AI Stock Screening You Won\'t Find Anywhere Else',
        'screening-desc': 'Find good stocks based on verified numbers and everything the web has to offer. Meet the screening on <span class="ollarai-brand">Ollarai</span> that precisely filters undervalued, growing companies — powered by financial data and performance metrics extracted directly from original filings, plus a future-event calendar for every company.',
        'screening-point1': 'Filtering based on verified financial metrics like PER, ROE, and operating margin',
        'screening-point2': 'Scoring computed from original filing data and the event calendar',
        'screening-point3': 'Cross-border screening spanning Korea, the US, and Japan',
        ...
        'footer-company': '',
        'footer-copyright': `&copy; ${new Date().getFullYear()} Ollarai. All rights reserved.`,
    ...
    ja: {
        ...
        'screening-title': 'どこにもないAI株式スクリーニング',
        'screening-desc': '検証された数字とウェブ上に出回るすべての情報をもとに、良い銘柄を見つけましょう。開示原本から直接抽出した財務データと業績指標、そして企業ごとの今後のイベントカレンダーで、割安な成長企業を精密に絞り込むスクリーニングを<span class="ollarai-brand">Ollarai</span>で体験してください。',
        'screening-point1': 'PER、ROE、営業利益率など検証済みの財務指標に基づくフィルタリング',
        'screening-point2': '開示原本データとイベントカレンダーから算出したスコアリング',
        'screening-point3': '韓国・米国・日本の市場をまたぐクロスボーダースクリーニング',
